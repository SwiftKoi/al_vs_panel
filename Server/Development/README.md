...
`Data/` directory. The displayed total is the current `Data/` size plus free
filesystem space, excluding unrelated usage elsewhere on the disk.
...
after boot. Installation commands are provided in the handoff accompanying
these files.
